describe('Asset', function() {
    ...
    describe("constructor", function () {
        ...
        it("throws an error when there's no issuer for non XLM type asset", function () {
            expect(() => new DigitalBitsBase.Asset("USD")).to.throw(/Issuer cannot be null/)
        });

        it("throws an error when code is invalid", function () {
            expect(() => new DigitalBitsBase.Asset("", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ")).to.throw(/Asset code is invalid/)
            expect(() => new DigitalBitsBase.Asset("1234567890123", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ")).to.throw(/Asset code is invalid/)
            expect(() => new DigitalBitsBase.Asset("ab_", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ")).to.throw(/Asset code is invalid/)
        });

        it("throws an error when issuer is invalid", function () {
            expect(() => new DigitalBitsBase.Asset("USD", "GCEZWKCA5")).to.throw(/Issuer is invalid/)
        });
    });
    ...
    describe("getCode()", function () {
        ...
        it("returns a code for a non-native asset", function () {
            var asset = new DigitalBitsBase.Asset("USD", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
    ...
    describe("getAssetType()", function () {
        ...
        it("returns credit_alphanum4 if the asset code length is between 1 and 4", function () {
            var asset = new DigitalBitsBase.Asset("ABCD", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
        ...
        it("returns credit_alphanum12 if the asset code length is between 5 and 12", function () {
            var asset = new DigitalBitsBase.Asset("ABCDEF", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
    ...
    describe("toXDRObject()", function () {
        ...
        it("parses a 4-alphanum asset object", function () {
            var asset = new DigitalBitsBase.Asset("BART", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
            var xdr = asset.toXDRObject();
        ...
        it("parses a 5-alphanum asset object", function () {
            var asset = new DigitalBitsBase.Asset("12345", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
            var xdr = asset.toXDRObject();
        ...
        it("parses a 12-alphanum asset object", function () {
            var asset = new DigitalBitsBase.Asset("123456789012", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
            var xdr = asset.toXDRObject();
